...
CONFIG_PATH = "configs/plant/close10_sam3mask_fgweighted_7000.yaml"
CHECKPOINT_PATH = "/cluster/project/cropsci/jmercoli/4dgs_project/outputs/close10_dynamic_sam3mask_fgweighted_7000/chkpnt_best.pth"
OUT_DIR = Path("/cluster/project/cropsci/jmercoli/4dgs_project/outputs/close10_dynamic_sam3mask_fgweighted_7000/all_timesteps_cam0")
N_FRAMES = 10
