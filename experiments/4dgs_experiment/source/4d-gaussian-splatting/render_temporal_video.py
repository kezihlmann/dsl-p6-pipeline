...
CONFIG_PATH = "configs/plant/close10_3000.yaml"
CHECKPOINT_PATH = "/cluster/project/cropsci/jmercoli/4dgs_project/outputs/close10_dynamic_3000/chkpnt_best.pth"
OUT_DIR = Path("/cluster/project/cropsci/jmercoli/4dgs_project/outputs/close10_dynamic_3000/temporal_video_close10_cam0")
N_FRAMES = 60
